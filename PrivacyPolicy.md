...
This privacy policy is applicable to the Prayer Times app (hereinafter referred to as "Application") for mobile devices, which was developed by Enes Nurullah Kendirci (hereinafter referred to as "Service Provider") as a an Ad Supported service. This service is provided "AS IS".
